...
session_start();
$salesManagerID = $_COOKIE['ManagerID']; // 修改這裡
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $managerName = htmlspecialchars($row['managerName']); // 修改這裡
...
<body class="w3-content" style="max-width:1200px">
    ...
    <div class="w3-main" style="margin-left:250px">
        ...
        <header class="w3-container w3-xlarge">
            <a href="../item.html" style="text-decoration: none;"><img class="logo" src="../photo/logo.png" style="width: 88px; height: auto; float: left; margin-right: 10px;margin-left: 10px;"></a>
            <p class="w3-left">Smart & Luxury Motor Company</p>
            <p class="w3-right">
                <a href="salesUpDate.php" style="text-decoration: none;"><img src="../photo/userin.png" width="32" height="auto"></a>
                <a href="../report.html" style="text-decoration: none;"><img src="../photo/report.png" width="25" height="25"></a>
                <a href="../item.html" style="text-decoration: none;"><img src="../photo/stock.png" width="25" height="25"></a>
                <a href="../Sales Order records.html" style="text-decoration: none;"><img src="../photo/record.png" width="25" height="auto"></a>
                <a href="logout.php" style="text-decoration: none;"><img src="../photo/logout.png" width="35" height="auto"></a>
            </p>
        </header>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validateForm()">
            <div style="display: flex; flex-direction: column; align-items: center;">
                <div style="display: flex; gap: 20px;">
                    <div>
                        <label for='tel'>Contact Number:</label> <input id='tel' name='tel' pattern='^[0-9]{8}$' type='text' value="<?php echo "$contactNumber" ?>">
                    </div>
                </div>
            </div>
            <br><br>
            <div style="display: flex; justify-content: center;">
                <fieldset>
                    <legend>Edit Password</legend> <label for="passwd">
                        <input id="passwd" name="passwd" pattern="^(?=.*[A-Za-z])[\w]{5,}$" placeholder=" Enter new password (8 number minimum)" size="50" title="Must contain at least one letter and at least 8 or more characters." type="password">
                    </label><br>
                    <label for="passwd2"><input id="passwd2" name="passwd2" placeholder=" Enter password again" size="50" title="Enter the password again" type="password"></label>
                    <div id="samePw"></div>
                </fieldset>
            </div>
            <br>
