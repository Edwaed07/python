	...
	<div class="w3-main" style="margin-left:250px">
		...
		<header class="w3-container w3-xlarge">
			...
			<p class="w3-right"><a href="update.php" style="text-decoration: none;"><img height="auto"
						src="../photo/userin.png" width="32"></a> <a href="../carlist.html"
					style="text-decoration: none;"><img height="auto" src="../photo/list.png" width="35"></a> <a
					href="../order%20record.html" style="text-decoration: none;"><img height="auto"
						src="../photo/record.png" width="25"></a> <a href="logout.php"
					style="text-decoration: none;"><img height="auto" src="../photo/logout.png" width="35"></a></p>
		</header>
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validateForm()">
			...
			<div style="display: flex; flex-direction: column; align-items: center;">
				<div style="display: flex; gap: 20px;">
					...
					<div>
						<label for='fax'>Fax Number:</label> <input id='fax' name='fax' pattern='^[0-9]{8}$' type='text'
							value="<?php echo "$faxNumber" ?>">
					</div>
				</div>
				<div>
